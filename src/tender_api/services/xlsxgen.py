...
def build_project_plan(tender, score, team, months, rate, margin) -> bytes:
    ...
    wb = Workbook()
    _sheet_requerimientos(wb, wb.active, tender, team, st)
...
def _sheet_requerimientos(wb, ws, tender, team, st) -> None:
